      ...
      >
        ...
        >
          <Dialog.Panel className="mx-auto mt-0 sm:bg-transparent sm:max-h-90vh w-full  h-screen sm:pb-10">
            <Command className="max-h-full overflow-y-auto w-full  sm:shadow-2xl py-10 bg-gray-100">
                    ...
                    >
                      ...
                      {results.map((item: any, index: number) => (
                        <div
                          ...
                          onClick={() => handlePush(`/product/${item._id}`)}
                        >
                          <div className="h-full overflow-hidden rounded-l-xl hover:underline">
                            <p>{item.title}</p>
                          </div>
                        </div>
                      ))}
